...
public:
    vector<int> sortArrayByParityII(vector<int>& nums) {
        ...
        // according values at their even and odd places
        // So the solution can be thought as we will check current index
        // if index is value is even then we will skip it to next+1 index to
        // skip odd index
        // same for odd index
        // out loop will run until evenindex and odd index are less than nums
        // size
        int evenindex = 0;
        int oddindex = 1;
